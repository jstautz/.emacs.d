...
Instead of an alphabetized and ugly bulk-dump of every package I use, I've spread the declarations and configs for my packages throughout this file in places where they make logical sense.

When I talk about UI tweaks, for example, I can talk about how I load and configure the smart-mode-line package. 

I still want Emacs to *load* all these packages in bulk, however, so I'll list them with noweb links here:
