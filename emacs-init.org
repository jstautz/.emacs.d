...
3. *Sharing my setup is easier*
   ...
   - Better, more detailed explanations of my code mean it's also easier for others to understand it and benefit from it.
...
This is a little sloppier than I'd like[fn:1], but I'm leaving it in place until I have time to sort out a better option.

[fn:1] I'm deliberately ignoring the chicken-and-the-egg problem here:
...
I don't keep *any* of my installed packages under version control at the moment. If I install Emacs config from scratch, el-get will bootstrap itself and start downloading/loading all the packages I need.[fn:3]
...
[fn:3] In theory. In practice this doesn't always work out. 
