...
And my end of line characters? Make 'em plain old LFs, please:
...
Adjust the way my mouse works:
- Emulate a three-button mouse for copy/paste/select
- When I drag and drop a file onto Emacs, visit that file rather than just appending it to the currently open buffer (which is a horrible default)
...
This wouldn't be a proper Emacs config if it didn't have a boatload of custom keybindings.
